...
class Student(models.Model):
    ...
    department = models.CharField(max_length=500, null=False, blank=False)
...
class Semester_Result(models.Model):
    ...
    def __str__(self):
        return f'{self.student.name} {self.semester} result for {self.session} session'
...
class Session_Result(models.Model):
    ...
    def __str__(self):
        return f'{self.student.name} result for {self.session} session'
